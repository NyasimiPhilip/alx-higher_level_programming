#!/usr/bin/python3
"""
This script takes arguments and displays all values in the 'states' table of 'hbtn_0e_0_usa'
where the name matches the argument, using a safe query to prevent MySQL injection.
"""
